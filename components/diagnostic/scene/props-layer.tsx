  ...
  switch (prop) {
    case "musica":
      ...
      return (
        ...
        >
          {/* suporte */}
          <rect x="170" y="760" width="60" height="14" rx="3" fill="#1b2536" />
          <rect x="195" y="700" width="10" height="60" fill="#2a3346" />
          {/* corpo */}
          <ellipse cx="200" cy="640" rx="42" ry="54" fill="#2a3346" />
          <ellipse cx="200" cy="640" rx="20" ry="26" fill="#0b1020" />
          {/* braço */}
          <rect x="194" y="430" width="12" height="180" fill="#1b2536" />
          <rect x="190" y="420" width="20" height="16" rx="3" fill="#2a3346" />
          {/* cordas */}
    ...
    case "jogar":
      ...
      return (
        <motion.g {...enter} style={{ transformOrigin: "1050px 540px" }}>
          <rect x="990" y="520" width="120" height="34" rx="10" fill="#1b2536" />
          <motion.rect
            x="1090"
            y="528"
            width="6"
          ...
          />
          {/* controle no chão */}
          <rect x="1010" y="600" width="80" height="30" rx="15" fill="#2a3346" />
    ...
    case "ler":
      ...
      return (
        <motion.g {...enter} style={{ transformOrigin: "120px 480px" }}>
          <rect x="80" y="300" width="140" height="420" rx="6" fill="#1b2536" />
          {[0, 1, 2, 3].map((s) => (
            <g key={s}>
              ...
              {Array.from({ length: 7 }).map((_, i) => (
                <rect
                  ...
                  height={64 - (i % 3) * 8}
                  rx="1"
                  fill={["#2a3346", "#222b3a", "#1c2a3a", "#2a2433"][i % 4]}
                />
              ))}
            </g>
          ))}
    ...
    case "receber":
      ...
      return (
        <motion.g {...enter} style={{ transformOrigin: "720px 760px" }}>
          <rect x="560" y="700" width="160" height="80" rx="16" fill="#2a3346" />
          <rect x="720" y="700" width="160" height="80" rx="16" fill="#2a3346" />
          <rect x="554" y="640" width="22" height="90" rx="8" fill="#1b2536" />
          <rect x="864" y="640" width="22" height="90" rx="8" fill="#1b2536" />
          {/* mesa redonda */}
          <ellipse cx="720" cy="700" rx="60" ry="16" fill="#1b2536" />
        </motion.g>
      );
    ...
    case "trabalhar":
      ...
      return (
        <motion.g {...enter} style={{ transformOrigin: "620px 620px" }}>
          <rect x="560" y="610" width="120" height="14" rx="3" fill="#1b2536" />
          <rect x="570" y="540" width="100" height="74" rx="6" fill="#2a3346" />
    ...
    case "descansar":
      ...
      return (
        ...
        >
          <rect x="1160" y="660" width="150" height="110" rx="22" fill="#2a3346" />
          <rect x="1160" y="610" width="26" height="100" rx="10" fill="#1b2536" />
          <rect x="1284" y="610" width="26" height="100" rx="10" fill="#1b2536" />
    ...
    case "tech":
      ...
      return (
        <motion.g {...enter} style={{ transformOrigin: "460px 760px" }}>
          ...
          <rect x="438" y="750" width="10" height="24" rx="3" fill="#1b2536" />
          <rect x="472" y="750" width="10" height="24" rx="3" fill="#1b2536" />
          <motion.circle
            cx="460"
            cy="690"
            r="40"
